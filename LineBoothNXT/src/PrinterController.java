    ...
    public void run() throws ClassNotFoundException, IOException {
        ...
        //for(int i=0; i<2; i++) {
            ...
            if(messageType == PrintJob.FOREGROUND_IMAGE || messageType == PrintJob.BACKGROUND_IMAGE) {
                ...
                byte[] imageBytes = new byte[numberOfColumns*numberOfRows];
                connection.read(imageBytes, numberOfColumns*numberOfRows);
                ...
                printJobQueue.add(new PrintJob(messageType, imageMap));
